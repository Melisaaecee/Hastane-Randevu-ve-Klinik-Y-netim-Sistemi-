...
public interface SlotRepository extends JpaRepository<Slot, Long> {
        ...
        // 1. Belirli bir doktorun, belirli bir durumdaki (Örn: AVAILABLE) tüm
        // slotlarını getirir
        // Randevu alma sayfasında doktor seçildikten sonra boş saatleri göstermek için
        // kullanılır.
        ...
        // Belirli bir doktorun, belirli bir gündeki (başlangıç ve bitiş saati arası)
        // slotlarını getir
        ...
        List<Slot> findByDoctorIdAndStatusNot(Long doctorId, SlotStatus status);

        @Query("""
                        SELECT s FROM Slot s
                        WHERE s.doctor.id = :doctorId
                        AND s.status <> com.hospital.management.Entity.SlotStatus.CANCELLED
