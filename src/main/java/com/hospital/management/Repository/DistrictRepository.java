...
public interface DistrictRepository extends JpaRepository<District, Long> {
    ...
    // 1. Şehir ID'sine göre tüm ilçeleri listeler (Hiyerarşik seçim için en kritik
    // metot)
    ...
    // 4. Bir ilçenin gerçekten belirtilen şehre ait olup olmadığını kontrol eder
    // (Kritik metot)
    ...
    List<District> findByCityIdWithDetails(@Param("cityId") Long cityId);
